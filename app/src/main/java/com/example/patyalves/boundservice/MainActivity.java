...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button stopTimestampButton=(Button)findViewById(R.id.stop_service);
        ...
        stopTimestampButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(mServiceBound){
                ...
                Intent itent=new Intent(MainActivity.this, BoundService.class);
            }
        });
